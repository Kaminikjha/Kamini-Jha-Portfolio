...
const Experience = () => {
  return (
    <div id="experience" className="text-white pb-5 md:pb-16 px-4 md:px-8 pt-24">
      <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold leading-tight tracking-tighter mb-8 md:mb-10 text-center">My Experience</h2>
      
      <div className="grid grid-cols-3 md:grid-cols-5 gap-4 max-w-6xl mx-auto">
        {[htmlIcon, cssIcon, jsIcon, reactIcon,   tailwindIcon, bootstrapIcon, mongodb, nodejs,  canvaIcon].map((icon, index) => (
          <motion.div
            key={index}
      ...
      <div className="mt-16 space-y-8 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 text-md md:text-lg">Nov 2024 - May 2025 (6 months internship)</p>
